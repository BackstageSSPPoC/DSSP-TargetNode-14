...
// Repo: multilang-nodejs | Env: dev
// Stack: nodejs / express / npm
...
// ================= CI STAGES =================
        ...
        stage('Application Validation') {
            steps {
                sh '''
                node --check $(node -p "require('./package.json').main || 'index.js'") || true
                '''
            }
        }
                      ...
                      withSonarQubeEnv('SonarQube') {
                          sh """
                              ${scannerHome}/bin/sonar-scanner \
                                  ...
                                  -Dsonar.sources=. -Dsonar.exclusions=node_modules/**,coverage/** \
...
// ================= CD STAGES =================
        ...
        stage('Build Docker Image') {
            ...
            steps {
                sh "docker build --build-arg CONTEXT_PATH=${APP_NAME}-${DEPLOY_NAMESPACE} -t ${IMAGE_TAG} ."
            }
        }
